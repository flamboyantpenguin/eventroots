...
export default function Admin() {
  ...
  // Administrative Gateway Form State
  ...
  const handleAdminLoginSubmit = async (e) => {
    ...
    try {
      const authorizedUser = await login(adminEmail, adminPassword, true);
  ...
  const openAdd = (type) => {
    setAdd(type);
    setForm(type === "user" ? { status: "active" } : {});
    setErrors({});
  };
    ...
    <>
      <div className="admin">
        <aside className="sidebar">
          ...
          <div
            className="logout"
            onClick={() => window.confirm("Logout?") && alert("Logged out.")}
          >
        ...
        {edit && (
          <Modal
            ...
            saveLabel={
              <>
                <SaveRoundedIcon sx={{ fontSize: 14 }} /> Save
              </>
            }
          >
        ...
        {add && (
          <Modal
            ...
            saveLabel={
              <>
                <SaveRoundedIcon sx={{ fontSize: 14 }} /> Add
              </>
            }
          >
